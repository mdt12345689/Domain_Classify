...
database = client["admin"]  # Thay thế "ten_database" bằng tên database thực tế của bạn
collection = database["Domain_Classify"]  # Thay thế "ten_collection" bằng tên collection thực tế của bạn

# Prepare training data
X = [app['Domain'] for app in collection.find() if 'Domain' in app]
y = [app['App'] for app in collection.find() if 'Domain' in app]
